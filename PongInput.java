    ...
    public static void main(String[] args) {
        ...
        while(WINNER == -1){
            ...
            if (StdDraw.hasNextKeyTyped()){
                ...
                if (key == 'w') System.out.println("player 1 paddle up");
                else if (key == 's') System.out.println("player 1 paddle down");
                else if (key == 'i') System.out.println("player 2 paddle up");
                else if (key == 'k') System.out.println("player 2 paddle down");
            }
        }
    }
}
